/*
===========================================================================================================================================
	Filename		SMC.usp_XIRR_1Yr
	Author			John Alton
	Date			11/2015
	Description		Calculate the XIRR for 1 year
===========================================================================================================================================
*/
...
IF EXISTS (
  SELECT * 
   ...
   WHERE SPECIFIC_SCHEMA = N'SMC'
     AND SPECIFIC_NAME = N'usp_XIRR_1Yr' 
)
   DROP PROCEDURE SMC.usp_XIRR_1Yr
GO

CREATE PROCEDURE SMC.usp_XIRR_1Yr
AS
--*/
