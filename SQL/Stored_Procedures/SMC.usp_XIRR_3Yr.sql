/*
===========================================================================================================================================
	Filename		SMC.usp_XIRR_3Yr
	Author			John Alton
	Date			11/2015
	Description		Calculate the XIRR for 3 year
...
IF EXISTS (
  SELECT * 
   ...
   WHERE SPECIFIC_SCHEMA = N'SMC'
     AND SPECIFIC_NAME = N'usp_XIRR_3Yr' 
)
   DROP PROCEDURE SMC.usp_XIRR_3Yr
GO

CREATE PROCEDURE SMC.usp_XIRR_3Yr
AS
