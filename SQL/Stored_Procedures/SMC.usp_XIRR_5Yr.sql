/*
===========================================================================================================================================
	Filename		SMC.usp_XIRR_5Yr
	Author			John Alton
	Date			11/2015
	Description		Calculate the XIRR for 5 year
...
IF EXISTS (
  SELECT * 
   ...
   WHERE SPECIFIC_SCHEMA = N'SMC'
     AND SPECIFIC_NAME = N'usp_XIRR_5Yr' 
)
   DROP PROCEDURE SMC.usp_XIRR_5Yr
GO

CREATE PROCEDURE SMC.usp_XIRR_5Yr
AS
