...
IF EXISTS (
  SELECT *
   ...
   WHERE sys.schemas.name = N'SMC'
	 AND sys.tables.name = N'MonthlyPerformanceGroupIRR'
)
  DROP TABLE SMC.MonthlyPerformanceGroupIRR
GO
...
CREATE TABLE [SMC].[MonthlyPerformanceGroupIRR](
 ...
 [SMC_LoadDate] DATETIME NULL DEFAULT getdate(), 
    CONSTRAINT [PK_MonthlyPerformanceGroupIRR] PRIMARY KEY CLUSTERED 
(
